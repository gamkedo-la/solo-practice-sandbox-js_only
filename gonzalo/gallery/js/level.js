...
export class Level {
  ...
  update(dt) {
	...
	const timeIndex = Math.floor(Level.#TIMER*1000/TIME_SLOT) - 1;

	if (Level.#TIMER > TIME_SLOT) {
	  Level.#TIMER = 0;
	  this.waveIndex = (this.waveIndex + 1) % this.levelData.length;
	  ...
	  if (typeof enemySpecs != "undefined") {
		...
		console.log("Time for a new wave!");
	  }
	}
  }
