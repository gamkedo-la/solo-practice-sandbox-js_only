...
var meepNormalPic=document.createElement("img");
var meepBluePic=document.createElement("img");
var meepRedPic=document.createElement("img");
var tilePics = [];
var meeplePics = [];
...
function loadImages() {
  ...
  var imageList = [
    ...
    {varName:meepNormalPic, theFile:"meep-normal.png"},
    {varName:meepBluePic, theFile:"meep-blue.png"},
    {varName:meepRedPic, theFile:"meep-red.png"},
